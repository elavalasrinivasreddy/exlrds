...
regressor = RandomForestRegressor(n_jobs=8, n_estimators=500, criterion ='mse', random_state =0)
...
# Fitting Decision Tree onto Training set
from sklearn.ensemble import RandomForestRegressor
regressor = RandomForestRegressor(n_jobs=8, n_estimators=500, criterion ='mae', random_state =0)
regressor.fit(X_train, Y_train)
