...
print(train_rmse) # 26.43
# Both .score(), r2_score gives us a accuracy score prediction
print(regressor.score(X_train, Y_train)) # 0.15
print(r2_score(Y_train, train_pred)) # 0.15

# Predicting the results on test-set
test_pred = regressor.predict(X_test)
test_error = Y_test - test_pred
test_rmse = np.sqrt(np.mean(test_error**2))
print(test_rmse) # 8.81
# Both .score(), r2_score gives us a accuracy score prediction
print(regressor.score(X_test, Y_test)) # 0.40
print(r2_score(Y_test, test_pred)) # 0.40
...
train_error = Y_train - train_pred
train_rmse = np.sqrt(np.mean(train_error**2))
print(train_rmse) # 28.03
# Both .score(), r2_score gives us a accuracy score prediction
print(regressor.score(X_train, Y_train)) # 0.05
print(r2_score(Y_train, train_pred)) # 0.05

# Predicting the results on test-set
test_pred = regressor.predict(X_test)
test_error = Y_test - test_pred
test_rmse = np.sqrt(np.mean(test_error**2))
print(test_rmse) # 9.85
# Both .score(), r2_score gives us a accuracy score prediction
print(regressor.score(X_test, Y_test)) # 0.255
print(r2_score(Y_test, test_pred)) # 0.255
